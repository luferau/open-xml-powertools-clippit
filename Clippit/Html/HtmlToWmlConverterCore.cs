...
namespace Clippit.Html
{
    ...
    public class HtmlToWmlConverterCore
    {
        ...
        private static XElement AddPseudoCells(XElement html)
        {
            while (true)
            {
                var rowSpanCell = html.Descendants(XhtmlNoNamespace.td)
                    .FirstOrDefault(td =>
                        td.Attribute(XhtmlNoNamespace.rowspan) != null && td.Attribute("HtmlToWmlVMergeRestart") == null
                    );
                if (rowSpanCell == null)
                    break;
                ...
                var rowsToAddTo = tr.ElementsAfterSelf(XhtmlNoNamespace.tr).Take(numberPseudoToAdd).ToList();
                foreach (var rowToAddTo in rowsToAddTo)
                {
                    ...
                    {
                        var tdToAddBefore = rowToAddTo.Elements(XhtmlNoNamespace.td).Skip(colNumber).FirstOrDefault();
                        var td = new XElement(
                            XhtmlNoNamespace.td,
                            rowSpanCell.Attributes(),
                            new XAttribute("HtmlToWmlVMergeNoRestart", "true")
        ...
        private static void AnnotateOlUl(WordprocessingDocument wDoc, XElement html)
        {
            ...
            foreach (
                var item in html.DescendantsAndSelf()
        ...
        private static void UpdateMainDocumentPart(
        ...
        private static object TransformWhiteSpaceInPreCodeTtKbdSamp(XNode node, bool inPre, bool inOther)
        {
            ...
            if (element != null)
            {
                ...
                if (
                    element.Name == XhtmlNoNamespace.code
        ...
        {
            var runsWithWidth = body.Descendants(W.r)
            ...
            foreach (var run in runsWithWidth)
            {
                ...
                var npSpRun = new XElement(W.r, run.Attributes(), run.Elements(W.rPr), new XElement(W.t, "\u00a0"));
        ...
        private static object NormalizeTransform(XNode node)
        {
            ...
            if (element != null)
            {
                ...
                {
                    var groupedChildren = element.Elements().GroupAdjacent(e => e.Name == W.p || e.Name == W.tbl);
                    var newContent = groupedChildren.Select(g =>
                    {
                        if (g.Key == false)
                        {
                            var paragraph = new XElement(W.p, element.Elements(W.pPr), g.Where(gc => gc.Name != W.pPr));
        ...
        )
        {
            ...
            if (element != null)
            {
                ...
                if (
                    ...
                    && (string)element.Attribute(XhtmlNoNamespace.id) == "layoutsData"
                )
                    return null;
                ...
                if (element.Name == XhtmlNoNamespace.td)
                {
                    ...
                    var hasOtherThanSpansAndParas = element
                        .Descendants()
                        .Any(d => d.Name != XhtmlNoNamespace.span && d.Name != XhtmlNoNamespace.p);
                    if (tdText != "" || hasOtherThanSpansAndParas)
                    {
                        var newElementRaw = new XElement(
                            "dummy",
                            element
                                .Nodes()
                                .Select(n => Transform(n, settings, wDoc, NextExpected.Paragraph, preserveWhiteSpace))
                        );
                        var newElements = new XElement(
                            "dummy",
                            newElementRaw
                                .Elements()
                                .Select(e =>
                        ...
                        return new XElement(W.tc, GetCellProperties(element), newElements.Elements());
                    }
                    else
                    {
                        var p = new XElement(
                            ...
                            new XElement(W.r, GetRunProperties(element, settings), new XElement(W.t, ""))
                        );
        ...
        private static XElement FontMerge(XElement higherPriorityFont, XElement lowerPriorityFont)
        {
            ...
            var rFonts = new XElement(
                ...
                (
                    higherPriorityFont.Attribute(W.eastAsia) != null
                    || higherPriorityFont.Attribute(W.eastAsiaTheme) != null
                )
                ...
                (
                    higherPriorityFont.Attribute(W.hint) != null
                        ? higherPriorityFont.Attribute(W.hint)
        ...
        public class CharStyleAttributes
        {
            ...
            public CharStyleAttributes(XElement pPr, XElement rPr)
            {
                ...
                var rtl =
                    rtlel != null && (rtlel.Attribute(W.val) == null || rtlel.Attribute(W.val).ToBoolean() == true);
                var bidi = false;
                if (pPr != null)
                {
                    ...
                    bidi =
                        bidiel != null
                        && (bidiel.Attribute(W.val) == null || bidiel.Attribute(W.val).ToBoolean() == true);
                }
                Rtl = cs || rtl || bidi;
        ...
        public static FontType DetermineFontTypeFromCharacter(char ch, CharStyleAttributes csa)
        {
            ...
            if (csa.EastAsiaFont == "Times New Roman" && csa.AsciiFont == csa.HAnsiFont)
            {
                return FontType.Ascii;
            }
            ...
            {
                if (csa.Hint == "eastAsia" && csa.EastAsiaLang is "zh-hant" or "zh-hans")
                {
                    return FontType.EastAsia;
                }
                return FontType.HAnsi;
                    ...
                    if (xTextNode != null)
                    {
                        ...
                        var p = new XElement(
                            ...
                            new XElement(
                                ...
                                new XElement(W.t, GetXmlSpaceAttribute(textNodeString), textNodeString)
                            )
                        );
                        return p;
                    }
        ...
        private static XElement GetImageAsInline(
            XElement element,
            HtmlToWmlConverterSettings settings,
            WordprocessingDocument wDoc,
            Image bmp,
        ...
        private static XElement GetImageAsAnchor(
            XElement element,
            HtmlToWmlConverterSettings settings,
            WordprocessingDocument wDoc,
            Image bmp,
        ...
        )
        {
            ...
            var anchor = new XElement(
                ...
                new XElement(
                    WP.positionH,
                    new XAttribute(NoNamespace.relativeFrom, "column"),
                    new XElement(WP.posOffset, (long)relativeFromColumn)
                ),
                new XElement(
                    WP.positionV,
                    new XAttribute(NoNamespace.relativeFrom, "paragraph"),
                ...
                new XElement(
                    WP14.sizeRelH,
                    new XAttribute(NoNamespace.relativeFrom, "page"),
        ...
        private static XElement GetImageExtent(XElement img, Image bmp)
        {
            ...
            return new XElement(
                ...
                new XAttribute(NoNamespace.cy, (long)szEmu.m_Height)
            ); // in EMUs
        }
                    ...
                    new XElement(
                            ...
                            new XElement(
                                ...
                                new XElement(
                                    ...
                                    new XElement(
                                        ...
                                        new XElement(A14.useLocalDpi, new XAttribute(NoNamespace.val, "0"))
                                    )
                                )
                            ),
                        ...
                        new XElement(
                            ...
                            new XElement(
                                ...
                                new XElement(
                                    A.ext,
                                    new XAttribute(NoNamespace.cx, (long)szEmu.m_Width),
                                    new XAttribute(NoNamespace.cy, (long)szEmu.m_Height)
                                )
                            ),
                            new XElement(A.prstGeom, new XAttribute(NoNamespace.prst, "rect"), new XElement(A.avLst)),
        ...
        private static XElement[] GetSpacingProperties(XElement paragraph, HtmlToWmlConverterSettings settings)
        {
            ...
            listElement = paragraph
                .Ancestors()
                .FirstOrDefault(a => a.Name == XhtmlNoNamespace.ol || a.Name == XhtmlNoNamespace.ul);
            if (listElement != null)
            {
            ...
            if (
                paragraph.Name == XhtmlNoNamespace.td
                || paragraph.Name == XhtmlNoNamespace.th
                || paragraph.Name == XhtmlNoNamespace.caption
            )
            {
                ...
                beforeAutospacing = (string)
                    settings.DefaultSpacingElementForParagraphsInTables.Attribute(W.beforeAutospacing);
                after = (long?)settings.DefaultSpacingElementForParagraphsInTables.Attribute(W.after);
                afterAutospacing = (string)
                    settings.DefaultSpacingElementForParagraphsInTables.Attribute(W.afterAutospacing);
            }
            ...
            if (paragraph.Name == XhtmlNoNamespace.li)
            {
                ...
                if (listElement2 != null)
                {
                    ...
                    {
                        var nextListElement = next.Ancestors()
                            .FirstOrDefault(a => a.Name == XhtmlNoNamespace.ol || a.Name == XhtmlNoNamespace.ul);
                        var nextNumberedItemAnnotation = nextListElement.Annotation<NumberedItemAnnotation>();
                        if (
                            nextNumberedItemAnnotation != null
                            && thisNumberedItemAnnotation.numId == nextNumberedItemAnnotation.numId
                        )
        ...
        internal static XElement GetRunProperties(XElement element, HtmlToWmlConverterSettings settings)
        {
            ...
            var color =
                colorPropertyString != null ? new XElement(W.color, new XAttribute(W.val, colorPropertyString)) : null;
            ...
            if (
                bAncestor
                || strongAncestor
                || fontWeightString is "bold" or "bolder" or "600" or "700" or "800" or "900"
            )
            {
        ...
        internal static string GetDisplayText(XText node, bool preserveWhiteSpace)
        {
            ...
            var newString = groupedCharacters
                .Select(g =>
                {
                    if (g.Key)
                        return " ";
        ...
        private static XElement GetTableWidth(XElement element)
        {
            ...
            if (width.IsAuto)
            {
                return new XElement(W.tblW, new XAttribute(W._w, "0"), new XAttribute(W.type, "auto"));
            }
            var widthElement = new XElement(
                W.tblW,
        ...
        private static XElement GetCellWidth(XElement element)
        {
            ...
            if (width.IsAuto)
            {
                return new XElement(W.tcW, new XAttribute(W._w, "0"), new XAttribute(W.type, "auto"));
            }
            var widthElement = new XElement(
                W.tcW,
                new XAttribute(W._w, (long)(Twip)width),
        ...
        private static List<XAttribute> GetBorderAttributes(XElement element, string whichBorder)
        {
            ...
            var attList = new List<XAttribute>() { val, sz, space, color };
            return attList;
        }
        ...
        private static XElement GetTableGrid(XElement element, HtmlToWmlConverterSettings settings)
        {
            ...
            var tblGrid = new XElement(
                W.tblGrid,
                columnWidths.Select(cw => new XElement(
                    W.gridCol,
        ...
        {
            var rowList = table
                .DescendantsTrimmed(XhtmlNoNamespace.table)
        ...
        {
            var gridSpan = new XElement(W.gridSpan, new XAttribute(W.val, 3));

            var tcBorders = GetBlockContentBorders(element, W.tcBorders, false);
            if (tcBorders == null)
                tcBorders = new XElement(
                    W.tcBorders,
            ...
            return new XElement(W.tcPr, gridSpan, tcBorders, shd, tcMar, vAlign, hideMark);
        }
        ...
        private static XElement GetCellProperties(XElement element)
        {
            ...
            return new XElement(W.tcPr, tblW, gridSpan, vMerge, tcBorders, shd, tcMar, vAlign, hideMark);
        }
        ...
        private static XElement GetCellHeaderProperties(XElement element)
        {
            ...
            return new XElement(W.tcPr, tblW, tcBorders, shd, tcMar, vAlign, hideMark);
        }
        ...
        private static XElement GetCellMargins(XElement element)
        {
            ...
            if ((long)topProp == 0 && (long)leftProp == 0 && (long)bottomProp == 0 && (long)rightProp == 0)
                return null;
            XElement top = null;
            if (topProp != null)
                top = new XElement(W.top, new XAttribute(W._w, (long)(Twip)topProp), new XAttribute(W.type, "dxa"));
            XElement left = null;
            if (leftProp != null)
                left = new XElement(W.left, new XAttribute(W._w, (long)(Twip)leftProp), new XAttribute(W.type, "dxa"));
            ...
            var tcMar = new XElement(W.tcMar, top, left, bottom, right);
            ...
            if (table != null)
            {
                ...
                if (borderCollapse == null || borderCollapse != "collapse")
                {
                    ...
                    if (marginTopProperty == null)
                        marginTopProperty = new CssExpression
                        {
                    ...
                    if (marginBottomProperty == null)
                        marginBottomProperty = new CssExpression
                        {
                            Terms = new List<CssTerm>
                            {
                                new CssTerm
                    ...
                    tblCellSpacing = new XElement(
                        W.tblCellSpacing,
                        new XAttribute(W._w, twipToUseOverTwo),
                        new XAttribute(W.type, "dxa")
                    );
                }
            }
  ...
  <w:right w:w='15'
        ...
        private static XElement GetTableRowProperties(XElement element)
        {
            ...
            if (table != null)
            {
                ...
                if (cellHeights.Any())
                {
                    ...
                    trHeight = new XElement(W.trHeight, new XAttribute(W.val, max));
                }
                ...
                trPr = new XElement(W.trPr, GetTableCellSpacing(element), trHeight);
    ...
    {
        public static void UpdateFontsPart(
            WordprocessingDocument wDoc,
            XElement html,
            HtmlToWmlConverterSettings settings
        )
    ...
    internal class NumberingUpdater
    {
        public static void InitializeNumberingPart(WordprocessingDocument wDoc)
        {
            ...
            if (numberingPart == null)
            {
                ...
                var npXDoc = new XDocument(new XElement(W.numbering, new XAttribute(XNamespace.Xmlns + "w", W.w)));
  ...
  <w:lvl w:ilvl='8' w:tentative='1'>
    ...
    <w:rPr>
      ...
      <w:sz w:val='20' />
        ...
        public static void UpdateNumberingPart(
            WordprocessingDocument wDoc,
            XElement html,
            HtmlToWmlConverterSettings settings
        )
        {
                ...
                if (!numToAbstractNum.ContainsKey(nia.numId))
                {
                    ...
                    if (list.Name == XhtmlNoNamespace.ol)
                    {
                        ...
                        for (var i = 0; i < numFmt.Length; ++i)
                        {
                            numFmt[i] = "decimal";
                            just[i] = "left";
                            var itemAtLevel = numberingElements.FirstOrDefault(nf =>
                            {
                            ...
                            {
                                var thisLevelNia =
                                    itemAtLevel.Annotation<HtmlToWmlConverterCore.NumberedItemAnnotation>();
                        ...
                        var simpleNumAbstract = XElement.Parse(
                            string.Format(
                                OrderedListAbstractXml,
                                currentAbstractId++,
                                numFmt[0],
                                just[0],
                                numFmt[1],
            ...
            foreach (var list in numToAbstractNum)
            {
                numberingXDoc.Root.Add(
                    new XElement(
                        W.num,
                        new XAttribute(W.numId, list.Key),
  ...
  <w:num w:numId='1'>
    ...
    internal class StylesUpdater
    {
        ...
        )
        {
            ...
            var classes = html.DescendantsAndSelf()
                .Where(d =>
                    d.Attribute(XhtmlNoNamespace._class) != null
                    && ((string)d.Attribute(XhtmlNoNamespace._class)).Split().Length == 1
                )
                    ...
                    if (selector != null)
                    {
                        ...
                        var newStyle = new XElement(
                            ...
                            new XElement(
                                ...
                                color != null
                                    ? new XElement(W.color, new XAttribute(W.val, "this should be a color"))
                                    : null,
  ...
  <w:rPr>
    ...
    {
        public static void UpdateThemePart(
            WordprocessingDocument wDoc,
            XElement html,
            HtmlToWmlConverterSettings settings
        )
